...
/**
 * Description of ClassificacaoChamadoDAO
 *
 * @author cesantos
 */
class ClassificacaoChamadoDAO {
    ...
    public function classificacaoChamadoCombo() {
        try {
            $query = "select spchamado_class.spchamado_class_id, spchamado_class.spchamado_class_desc, spchamado_class.spchamado_class_obs from spchamado_class";
            $stmt = $this->conexao->prepare($query);
            $stmt->execute();
            return $stmt;
        } catch (PDOException $e) {
