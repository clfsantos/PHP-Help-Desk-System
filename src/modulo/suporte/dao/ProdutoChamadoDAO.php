...
/**
 * Description of ProdutoChamadoDAO
 *
 * @author cesantos
 */
class ProdutoChamadoDAO {
    ...
    public function listarProdutos() {
        try {
            $query = "SELECT * "
                    . "FROM spchamado_produto "
                    . "ORDER BY spchamado_produto_desc asc";
    ...
    public function produtoChamadoCombo() {
        try {
            $query = "SELECT spchamado_produto.spchamado_produto_id, spchamado_produto.spchamado_produto_desc "
                    . "FROM spchamado_produto "
                    . "ORDER BY spchamado_produto.spchamado_produto_desc ASC";
            $stmt = $this->conexao->prepare($query);
            $stmt->execute();
            return $stmt;
        } catch (PDOException $e) {
