...
$sort = filter_input(INPUT_POST, "sort") ? filter_input(INPUT_POST, "sort") : 'descricao_problema';
...
$stmt = $problemaManutencaoDAO->listar($busca, $offset, $rows, $sort, $order);

$result = array();
$result["total"] = $problemaManutencaoDAO->contarBusca($busca);
