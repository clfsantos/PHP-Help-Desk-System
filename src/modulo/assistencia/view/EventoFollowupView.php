...
$sort = filter_input(INPUT_POST, "sort") ? filter_input(INPUT_POST, "sort") : 'descricao_evento';
...
$stmt = $eventoFollowupDAO->listar($busca, $offset, $rows, $sort, $order);

$result = array();
$result["total"] = $eventoFollowupDAO->contarBusca($busca);
