...
$sort = filter_input(INPUT_POST, "sort") ? filter_input(INPUT_POST, "sort") : 'vdproduto_id';
...
$stmt = $produtoDAO->listar($busca, $offset, $rows, $sort, $order);

$result = array();
$result["total"] = $produtoDAO->contarBusca($busca);
